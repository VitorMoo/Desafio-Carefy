    ...
    <div class="table-container">
      <?php
        ...
        if ($foundBirthdays) {
            ...
            echo "<tr><th colspan='3'><h2>Feliz Aniversário,Caro Colaborador/a!🎂🥳</h2></th></tr>";
        }
        ...
        if ($foundBirthdays) {
            foreach ($employees as $employee) {
                ...
                if ($specialDate == $currentDate) {
                    ...
                    echo "<td><strong>" . $employee["DATA DE NASCIMENTO"] . "</strong></td>";
                    echo "<td>Aniversário</td>";
                    echo "</tr>";
                }
            }
        } else {
            echo "<tr><td colspan='3'><h2>Não há aniversariantes hoje.😔😔</h2></td></tr>";
        }
